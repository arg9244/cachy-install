...
# ESSENTIAL PACKAGES
# -------------------
essential_packages=(git github-cli chezmoi micro fastfetch starship wget ntfs-3g file-roller mpv transmission-cli transmission-remote-gtk neovim ripgrep gdu bottom nodejs lazygit python tree-sitter yazi kitty zen-browser-bin v2rayn-bin ayugram-desktop proxychains-ng ttf-jetbrains-mono-nerd qt5ct qt6ct kvantum kvantum-qt5)
